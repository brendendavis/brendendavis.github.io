...
function createCharacterFromForm() {
    ...
    window.currentCharacter = window.currentCharacter || {}; // store in a global
    ...
    document.getElementById('hitPoints').value = character.currentHitPoints;
    document.getElementById('hitDice').value = `${character.totalHitDice}${character.hitDieType}`;
